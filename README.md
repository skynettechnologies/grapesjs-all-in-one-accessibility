...
<script src="https://unpkg.com/grapesjs-all-in-one-accessibility"></script>
...
const editor = grapesjs.init({
  ...
  plugins: ['grapesjs-all-in-one-accessibility'],
});
```

## Demo URL

```https://ui60qo26-aioa-website.grapesstudio.ai```
